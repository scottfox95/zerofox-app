  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('About to redirect to:', data.user.role === 'admin' ? '/admin' : '/');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mt-2">Sign In</h2>
          <p className="text-gray-600 mt-1">Access your compliance dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link href="/register" className="text-aravo-red font-semibold hover:underline">
                Sign up
              </Link>
            </p>
          </div>
